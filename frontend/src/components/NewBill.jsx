...
export default function NewBill({ onBillSaved }) { // Accept onBillSaved prop
    const [bill, setBill] = useState({
        bill_number: "", // Changed to empty string for initial input
        customer_name: "",
        mobile: "",
    ...
    useEffect(() => {
        ...
        // Fetch designs filtered by dress_type
        // You can add 'part' filter here if you want to filter designs by part in NewBill too
        ...
        <div className="p-6 bg-gray-50 min-h-screen">
            ...
            <form className="space-y-4 bg-white p-6 rounded shadow-md" onSubmit={handleSave}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input
                        type="text"
                        placeholder="Bill Number" // Added placeholder for bill number
