    ...
    return (
        <div className="p-6 bg-gradient-to-br from-[#FDF0F3] to-[#F2E5E8] min-h-screen font-inter">
            <h2 className="text-4xl font-extrabold text-[#754F4F] mb-8 rounded-xl p-4 bg-white shadow-xl text-center animate-fade-in flex items-center justify-center">
                <img
                    src="https://placehold.co/50x50/754F4F/FFFFFF?text=Bill"
                    alt="New Bill Icon"
            ...
            <form className="space-y-6 bg-white p-8 rounded-xl shadow-xl animate-fade-in-up" onSubmit={handleSave}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <input
                        ...
                        className="border border-gray-300 p-3 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-[#C7B4B4] transition-all duration-200"
                    ...
                    <select
                        ...
                        className="border border-gray-300 p-3 rounded-lg w-full bg-white focus:outline-none focus:ring-2 focus:ring-[#C7B4B4] transition-all duration-200"
                        required
                    >
                        {dressTypes.map(d => (
                    ...
                    <label className="block text-sm font-medium text-gray-700">Order Date:
                        <input
                            type="date"
                            className="border border-gray-300 p-3 rounded-lg w-full mt-1 focus:outline-none focus:ring-2 focus:ring-[#C7B4B4] transition-all duration-200"
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        {selectedMeasurements.map(m => (
                            <input
                                ...
                                type="text"
                                placeholder={m}
                                className="border border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#C7B4B4] transition-all duration-200"
                ...
                <div>
                    <div className="flex justify-between items-center mb-3">
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-[#D1A6AD] text-white rounded-full shadow-md hover:bg-[#C2949D] transition-all duration-200 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[#E0B8BE]"
                        >
                            + Add Item
                        </button>
                    </div>
                    ...
                    {bill.extras.map((extra, index) => (
                        <div key={index} className="flex gap-4 mb-3 items-center bg-gray-50 p-3 rounded-lg shadow-sm">
                            <input
                                ...
                                className="border border-gray-300 p-2 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-[#C7B4B4] transition-all duration-200"
                                value={extra.name}
                            ...
                            <input
                                type="number"
                                placeholder="₹ Price"
                                className="border border-gray-300 p-2 rounded-lg w-32 focus:outline-none focus:ring-2 focus:ring-[#C7B4B4] transition-all duration-200"
                                value={extra.price}
                ...
                <div className="text-3xl font-bold text-[#754F4F] mt-6 p-4 bg-[#F2E5E8] rounded-lg shadow-md text-center">
                ...
                <div className="flex flex-wrap gap-4 mt-6 justify-center">
                    <button
                        type="submit"
                        className="bg-[#D1A6AD] text-white px-6 py-3 rounded-full font-semibold shadow-lg transition-all duration-300 ease-in-out transform hover:scale-105 hover:bg-[#C2949D] focus:outline-none focus:ring-2 focus:ring-[#E0B8BE] focus:ring-opacity-75"
                    >
                    ...
                    {showPrint && (
                        <>
                            <button
                                type="button"
                                onClick={handlePrint}
                                className="bg-[#754F4F] text-white px-6 py-3 rounded-full font-semibold shadow-lg transition-all duration-300 ease-in-out transform hover:scale-105 hover:bg-[#603E3E] focus:outline-none focus:ring-2 focus:ring-[#9D7979] focus:ring-opacity-75"
                            >
                                🖨️ Print Bill
                            </button>
                            <button
                                ...
                                className="bg-[#EBE0E2] text-[#754F4F] px-6 py-3 rounded-full font-semibold shadow-lg transition-all duration-300 ease-in-out transform hover:scale-105 hover:bg-[#DED2D4] focus:outline-none focus:ring-2 focus:ring-[#F2E5E8] focus:ring-opacity-75"
                            >
                                ✨ New Bill
                            </button>
                        </>
            ...
            {showPrint && generatedBillNumber && ( // Only show printable bill if bill number is generated
                <div className="mt-8 bg-white p-8 rounded-xl shadow-xl animate-fade-in-up">
                    <h3 className="text-2xl font-bold text-center text-[#754F4F] mb-6">Print Preview</h3>
                    <div ref={printRef}>
